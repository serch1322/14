...
#    lineas_ids = fields.One2many('line.car.category','categorias',string="Categoria de Vahiculo",readonly=False)


#class CarrosAsegurados(models.Model):
#    _name = 'line.car.category'

#    categorias = fields.Many2one('car.category',string="Categoria de Vehiculos")
#    car = fields.Many2one('fleet.vehicle', string="Vehículo", required =True)
